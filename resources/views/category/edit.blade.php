<form id="form_update" action="{{ route('category.update', $data->id) }}" method="POST">
    <div class="row">
        @csrf
        @method('PUT')
        <div class="col-sm-12">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-10">
                        <input accept="image/png" onchange="image_check(this, 100)" title="upload icon images"
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input value="{{ $data->f_icon }}" required type="text" class="form-control" placeholder="Enter name"
                    name="f_icon">
            </div>
        </div>
