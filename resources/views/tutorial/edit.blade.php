                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <select name="status" class="form-control">
                                                ...
                                                <option {{ $data->status == 'inactive' ? 'selected' : '' }} value="inactive">
                                                    Deactive</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Quation</label>
                                                <textarea required class="form-control" placeholder="Enter questions" name="questions"> {{ $data->questions }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="30" cols="30" placeholder="Drop the full content here" class="form-control" id="editor1"
                                                    name="content">
