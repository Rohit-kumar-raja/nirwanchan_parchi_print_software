        ...
        <div class="iq-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                    <i class="ri-menu-line wrapper-menu"> <i class="fas fa-bars"></i> </i> 
                    <a href="{{ route('category.index') }}" class="header-logo">
                        ...
                        <h5 class="logo-title ml-3">{{ env('APP_NAME') }} {{ env('TRIAL_VERSION_NAME') }}</h5>
                                ...
                                <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <div class="card shadow-none m-0">
                                        <div class="card-body p-0 text-center">
                                            ...
                                            <div class="p-3">
                                                <h4 class="mb-1">{{ Auth::user()->name }}-{{ Auth::user()->email }}</h4>
                                                 {{-- <p class="mb-1"><a href="{{ route('admin.auth_change_password_show')}}">Password Change</a></p> --}}
